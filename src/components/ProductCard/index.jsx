    ...
    <div className="relative flex-none flex-grow-0 order-1 bg-white rounded-md cursor-pointer">
      <a className="relative inline-block" href="#">
        <img
          src={photo}
          alt={`Foto de ${title}`}
          className="object-cover aspect-[337/460]"
        />
